...
from nets2.ssd import SSD300
from utils2.anchors import get_anchors
from utils2.utils import (cvtColor, get_classes, preprocess_input, resize_image,
                         show_config)
from utils2.utils_bbox import BBoxUtility
...
class SSD(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : r"C:\Users\rog\Desktop\UI_design\detection_models\SSD.pth",
        "classes_path"      : 'model_data2/voc_classes.txt',
        #---------------------------------------------------------------------#
    ...
    def __init__(self, **kwargs):
        ...
        self.colors = [(0, 255, 0), (255, 255, 0), (255, 0, 0)]
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font = ImageFont.truetype(font='model_data2/msYahei.ttf', size=np.floor(5e-2 * np.shape(image)[1] + 0.5).astype('int32'))
