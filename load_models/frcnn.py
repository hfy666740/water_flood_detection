...
class FRCNN(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"    : "C:\\Users\\rog\\Desktop\\UI_design\\detection_models\\\Faster-RCNN.pth",
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='model_data/simhei.ttf', size=np.floor(0.1 * image.size[1] + 0.5).astype('int32'))
        ...
        for i, c in list(enumerate(top_label)):
            ...
            label_size = (bbox[2] - bbox[0], bbox[3] - bbox[1])  # (width, height)
